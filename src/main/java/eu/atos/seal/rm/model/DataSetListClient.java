...
public class DataSetListClient
{
    private String id;
    ...
    public static DataSetListClient getAttributeSetClientFrom(AttributeSet attributeSet)
    {
        DataSetListClient attributeSetClient = new DataSetListClient();
